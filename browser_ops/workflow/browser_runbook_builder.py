    ...
    if phase == "list":
        if effective_route == "human":
            ...
            runbook["steps"] = [
                ...
                {"kind": "note", "text": f"Deep analysis indicates human checkpoint needed={runbook.get('deepAnalysisSummary', {}).get('humanCheckpointNeeded', False)} and automationDifficulty={runbook.get('deepAnalysisSummary', {}).get('automationDifficulty', '')}/5."},
