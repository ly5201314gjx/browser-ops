...
from failure_recovery_engine import build_recovery_plan
...
if __name__ == "__main__":
    ...
    print(json.dumps({"ok": True, "output": str(Path(sys.argv[1]) / 'recovery_runbook.json'), "steps": len(rb['steps'])}, ensure_ascii=False))
